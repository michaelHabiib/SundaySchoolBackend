...
import {addNewEvent, DeleteEvent, GetAllEvents,
        updateEvent, UpdateDate,getEventsCount} from "../../Controlles/Events/Event-controlles";
...
EventRoutes.get(`/count`,getEventsCount) // function to get all events you have 
